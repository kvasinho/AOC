...
/// <summary>
/// The game class contians all the logic of a single input line. A game id and one or more sets.
/// It parses a full line and creates all necessary objects and furthermore calculates the smallest possible set and its power. 
/// </summary>
public class Game
    {
        /// <summary>
        ...
        /// <summary>
        /// Computed Field to find the smallest set with which a set would have been possible.
        /// Has to be as much as the largest number of each color of all sets. 
        /// </summary>
        /// <example>
        /// "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green" results in 4red, 2 greens and 6 blues
        /// </example>
        public GameSet GetSmallestPossibleGameSet
        {
            get
            {
                var smallestPossibleSet = new GameSet();
                
                smallestPossibleSet.Blue = GameSets.Max(set => set.Blue);
                smallestPossibleSet.Green = GameSets.Max(set => set.Green);
                smallestPossibleSet.Red = GameSets.Max(set => set.Red);

                return smallestPossibleSet;
            }
        }
        /// <summary>
        /// Calculated Field to return the power of all three colors in the smallest possible set. 
        /// </summary>
        public int GetSmallestPossibleGameSetPower => GetSmallestPossibleGameSet.Blue *
                                                      GetSmallestPossibleGameSet.Green * GetSmallestPossibleGameSet.Red;
