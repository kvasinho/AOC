...
namespace AOC2B
{
    ...
    {
        /// <summary>
        /// Reads the input file, extracts the game and its sets from each line and finds the power of the smallest possible cubes.
        ...
        public void Solve()
        {
            ...
            foreach (var line in lines)
            {
                ...
                sum += game.GetSmallestPossibleGameSetPower;
            }
